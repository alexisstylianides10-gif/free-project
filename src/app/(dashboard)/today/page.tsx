    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[13px] text-muted-foreground">
                {plannedCount > 0
                  ? `${plannedCount} block${plannedCount > 1 ? "s" : ""} on this day ${plannedCount > 1 ? "were" : "was"} planned by Alxioum around your deadlines and habits.`
                  : "Alxioum can build a recommended schedule from your calendar, tasks, goals, and habits."}
              </p>
            </div>
          </div>
        </div>
      ...
      {dayEvents.length === 0 && !proposal ? (
        <EmptyState
          ...
          body="Add an event, or let Alxioum build a recommended schedule from your tasks and deadlines."
          action={
            <>
