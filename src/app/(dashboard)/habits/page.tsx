    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-[13.5px] text-muted-foreground">
          {habits.length > 0 ? `${doneToday}/${habits.length} done today` : "Small routines Alxioum keeps in view."}
        </p>
      </div>
      ...
      {habits.length === 0 ? (
        <EmptyState
          icon={Repeat}
          title="No habits yet"
          body="Add a habit like drinking water, reading, or studying — Alxioum will track consistency and notice patterns over time."
        />
      ) : (
