    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[13.5px] text-muted-foreground">Everything that needs to get done, organized by Alxioum.</p>
        </div>
...
function emptyBody(key: string) {
  return {
    ...
    today: "You're clear for today. Alxioum will surface anything urgent on Home.",
