    ...
    <div className="flex h-[calc(100dvh-8.5rem)] flex-col md:h-[calc(100dvh-6rem)]">
      <div className="mb-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-[22px] font-semibold tracking-tight text-foreground">LifeOS AI</h1>
        </div>
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-1">
        {chat.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center gap-5 text-center">
            ...
            <div>
              <p className="text-[15px] font-semibold text-foreground">Tell LifeOS what you need</p>
