...
export default function InsightsPage() {
  ...
  const sections = [
    ...
    },
    {
      icon: TrendingUp,
      title: "Productivity",
      body: base.find((i) => i.title === "Productivity pattern")?.body ?? "Complete a few more tasks and LifeOS will start noticing your patterns.",
      tone: "neutral",
    },
    {
      icon: Target,
    ...
    },
    {
      icon: Repeat,
      title: "Habits",
      body: base.find((i) => i.title === "Habit consistency")?.body ?? "Start a habit and LifeOS will track your consistency here.",
      tone: "neutral",
    },
    {
      icon: BarChart3,
  ...
  return (
    <div className="space-y-5">
      ...
      {tasks.length === 0 && goals.length === 0 && habits.length === 0 ? (
        <EmptyState icon={Sparkles} title="Nothing to analyze yet" body="As you use LifeOS, patterns across your tasks, goals, habits, and spending will show up here." />
      ) : (
