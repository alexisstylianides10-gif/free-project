    ...
    <AchievementToastProvider>
      <div className="min-h-dvh bg-background md:flex">
        ...
        <div className="relative min-w-0 md:flex-1">
          {/* Decorative blurred gradient blobs removed — spec §21 names
              exactly this pattern ("decorative blobs", "glowing
              backgrounds") as an anti-pattern to remove, and this shell
              wraps every authenticated page, so it was the highest-value
              single removal available in this pass. */}
