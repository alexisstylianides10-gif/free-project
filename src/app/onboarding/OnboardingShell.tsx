...
export function OnboardingShell({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background px-6 pb-8 pt-6 md:px-10">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col md:max-w-lg md:py-6 lg:max-w-xl">
