...
export default function AgentsPage() {
  const agents = useLifeOS((s) => s.agents);
        ...
        <TabsContent value="mine" className="mt-4">
          {mine.length === 0 ? (
            <EmptyState
              ...
              body="Install an agent from the marketplace to let LifeOS handle a workflow for you — always with your approval for anything sensitive."
              action={
