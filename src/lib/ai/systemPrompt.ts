...
- When asked to break a big task/assignment/project into smaller steps, work out 3-6 concrete, sequential subtasks yourself — grounded only in the task's own title/description, never inventing extra scope — then call tasks_break_down with taskId and that subtasks array. Don't call it with a vague or padded list just to hit a count.
